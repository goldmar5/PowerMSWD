...
{
    public class SetStatePage : PanelGeneralFunctionalityPage
    {
        public SetStatePage()
        {
            expectedUnitTitle = "PANEL";
            expectedPanelFunctionalityPage = "Set State";
        }

        #region WebElements 

        [FindsBy(How = How.CssSelector, Using = @".unitStateLabel")]
        protected IWebElement unitStateLabel { get; set; }
        ...
        public override void Invoke()
        {
            ...
            PanelGeneralPage.SetStateClick();
        }
        ...
        public override void VerifyExpectedElementsAreDisplayed()
        {
            ...
            VerifyElementVisible("unitStateLabel", unitStateLabel);
        }

        public override void WaitLoadPage()
        {
            Wait.UntilVisible(unitStateLabel, 20000);
