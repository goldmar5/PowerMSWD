...
{
    public class AddCS : AddEditBasePage
    {

        public AddCS()
        {
            expectedCaption = "ADD CENTRAL STATION";
        }

        #region WebElements        

        [FindsBy(How = How.CssSelector, Using = @"#centralstationAddBusyButtonTop")]
        protected IWebElement btnSaveChangesAddCSTop { get; set; }

        [FindsBy(How = How.CssSelector, Using = @"#centralstationAddBusyButtonBottom")]
        protected IWebElement btnSaveChangesAddCSBottom { get; set; }
        ...
        public override void Open()
        {
            ...
            CentralStationSPage.AddCSClick();
        }
        ...
        public override void VerifyExpectedElementsAreDisplayed()
        {
            ...
            VerifyElementVisible("btnSaveChangesTop", btnSaveChangesAddCSTop);
            VerifyElementVisible("btnSaveChangesBottom", btnSaveChangesAddCSBottom);
        ...
        {
            Wait.UntilVisible(btnSaveChangesAddCSTop, 20000);
